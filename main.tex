...
\alex{put toy exemples when relevant in italic}\\

\sectionToc{Temporal optimization, some other approaches}

Let us now looked at temporal optimization more generally. We will present here the origin of the study as well as the different branches of researches developed these days. For each temporal approach, we will focus on the similarities and differences from the multistage framework.

\subsectionToc{Origin of the temporal optimization}
